...
Unlike the original repository, this version of PHP PhantomJS does not include PhantomJS.
You should [download it][1] separately and install it wherever you want, then specify the path
to your binary to the PhantomJS library like explained in the documentation below.

This means that you don't have to change anything on your `composer.json` as well, except adding
